...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole
 {
  ...
  function processItem(uint _upc) onlyFarmer harvested(_upc) verifyCaller(items[_upc].originFarmerID) public 
  ...
  function packItem(uint _upc) onlyFarmer processed(_upc) verifyCaller(items[_upc].originFarmerID) public 
  // Call modifier to check if upc has passed previous supply chain stage
  ...
  function sellItem(uint _upc, uint _price) onlyFarmer packed(_upc) verifyCaller(items[_upc].originFarmerID) public 
  // Call modifier to check if upc has passed previous supply chain stage
